...
export class ProductComponent implements OnInit {
  ...
  // product:any={}
  product1 = { productId: 1, productName: 'Bardak', categoryId: 1, unitPrice: 5 } //object { }
  ...
  products = [ this.product1 , this.product2 , this.product3 , this.product4 , this.product5 ] // array []
